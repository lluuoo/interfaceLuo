...
public class HotJobService {
	...
	private THrJobBaseDao myHrJobBaseDao;
	...
	public THrJobBaseDao getMyHrJobBaseDao() {
		return myHrJobBaseDao;
	}

	public void setMyHrJobBaseDao(THrJobBaseDao myHrJobBaseDao) {
...
//	}
	 ...
	 * @return 第2级职业类别信息集合
	 */
	public List<TopWorkTypeInfo> queryWorkTypesByFatherid(int pageNo, int pageSize, Long fatherId) {
		...
		// 将数据查询的结果转换成页面数据结果，并返回。
		for (TShowHomeworktypes toa : worktypes) {
			list.add(BeanTransNew.getFromTShowHomeworktypes(toa));
		}
