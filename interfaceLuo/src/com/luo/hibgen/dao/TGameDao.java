...
//			}
	...
	//根据id查询记录方法
	public  TGameFingerguess  findById(int id){
		return (TGameFingerguess)getHibernateTemplate().getSessionFactory().getCurrentSession().get(TGameFingerguess.class, id);
	}
	
	//修改记录
	public void update(TGameFingerguess  obj){
		getHibernateTemplate().getSessionFactory().getCurrentSession().save(obj);
	}
}
