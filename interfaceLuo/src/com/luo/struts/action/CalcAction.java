...
public class CalcAction extends BaseAction {
	...
	public void add() {
		returnJson = new JSONObject();
		double result = calcService.add(num1, num2); // 调用Service的业务逻辑处理方法
	...
	public void sub() {
		returnJson = new JSONObject();
		double result = calcService.sub(num1, num2); // 调用Service的业务逻辑处理方法
	...
	public void mul() {
		returnJson = new JSONObject();
		double result = calcService.mul(num1, num2); // 调用Service的业务逻辑处理方法
	...
	public void div() {
		...
		String info = "";
		try {
			double result = calcService.div(num1, num2); // 调用Service的业务逻辑处理方法
