...
public class TUserAccount implements java.io.Serializable {
	...
	public TUserAccount(String account, String password, Integer type, String phone, String email,
			String mailVerifyCode, Integer isMailVerified, String phoneVerifyCode, Integer isPhoneVerified,
			Integer status, Date lastlogin, Date createDate, Date updateDate) {
