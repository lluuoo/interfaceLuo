...
public class BeanTrans {
	...
	public static GameFingerGuessDataInfo getFromTGameFingerguess(TGameFingerguess tgf) {
		GameFingerGuessDataInfo gameFingerGuessDataInfo = new GameFingerGuessDataInfo();
		try {
			PropertyUtils.copyProperties(gameFingerGuessDataInfo, tgf);
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		} catch (InvocationTargetException e) {
			// TODO Auto-generated catch block
		...
		return gameFingerGuessDataInfo;
	}
	
	public static TShowHomeworktypesInfo getFromTShowHomeworktypes(TShowHomeworktypes tsh) {
		TShowHomeworktypesInfo tShowHomeworktypesInfo = new TShowHomeworktypesInfo();
		try {
			PropertyUtils.copyProperties(tShowHomeworktypesInfo, tsh);
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		} catch (InvocationTargetException e) {
			// TODO Auto-generated catch block
