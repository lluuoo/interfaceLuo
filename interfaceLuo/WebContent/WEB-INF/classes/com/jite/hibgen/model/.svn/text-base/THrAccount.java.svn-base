...
// Generated 2015-6-15 1:31:01 by Hibernate Tools 3.4.0.CR1
...
public class THrAccount implements java.io.Serializable {
	...
	public THrAccount(Long hrAccountId, String name, Integer sex, String title,
			String phone, String email, String headPic, Long companyId,
			Integer approveStatus, Integer isMain, Date createDate,
			Date updateDate) {
