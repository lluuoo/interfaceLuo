...
// Generated 2015-5-11 21:54:54 by Hibernate Tools 3.4.0.CR1
...
public class TOrgActive implements java.io.Serializable {
	...
	public TOrgActive(String org, String name, String icon, String images,
			String description, String location, Date fromTime, Date endTime,
			String contactName, String contactPhone, String contactEmail,
			Integer greatSum, Integer template, Integer maxJoin,
			Integer status, Integer rank, Date createDate, Date updateDate) {
		this.org = org;
		this.name = name;
		this.icon = icon;
		this.images = images;
